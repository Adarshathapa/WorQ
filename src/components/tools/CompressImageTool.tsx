...
export const CompressImageTool: React.FC = () => {
  ...
  const compressImage = async () => {
    ...
    try {
      ...
      const fileName = `WorQ-Ai_Compressed_${file.name}`;
