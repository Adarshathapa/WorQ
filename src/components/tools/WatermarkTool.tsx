...
export const WatermarkTool: React.FC = () => {
  ...
  const [watermarkText, setWatermarkText] = useState('WorQ-Ai');
  ...
  const addWatermark = async () => {
    ...
    try {
      ...
      const fileName = `WorQ-Ai_Watermarked_${Date.now()}.pdf`;
    ...
    <div className="flex flex-col gap-4 w-full animate-in fade-in duration-300">
      ...
      {outputUrl ? (
        <ProcessingResult 
          ...
          description="Your document is now protected."
        />
      ) : (
      ...
      <ToolGuide 
        ...
        seoContent="Watermark PDF online free with WorQ-Ai, the easiest way to add security to your files. Learn how to watermark PDF without losing quality using our high-performance on-device tools. Our secure watermark PDF tool ensures your data never leaves your browser, giving you a fast watermark PDF on mobile experience. Perfect for professional document protection."
        faqs={[
