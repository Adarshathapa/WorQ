...
export const SplitPdfTool: React.FC = () => {
  ...
  const splitPDF = async () => {
    ...
    try {
      ...
      const fileName = `WorQ-Ai_Split_${Date.now()}.pdf`;
    ...
    <div className="flex flex-col gap-4 w-full animate-in fade-in duration-300">
      ...
      {outputUrl ? (
        <ProcessingResult 
          ...
          onReset={() => { setFile(null); setOutputUrl(null); setPageRange(''); }}
          title="Split Complete!"
          description="Your extracted pages are ready."
        />
      ) : (
        <div className="flex flex-col gap-4">
          {!file ? (
            ...
            <div className="flex flex-col gap-4 animate-in slide-in-from-bottom-2 duration-300">
              ...
              <ProcessingProgressBar isProcessing={isProcessing} text="Processing files..." durationMs={1500} />
      ...
      <ToolGuide 
        ...
        seoContent="Split PDF online free using our high-precision extraction tool. WorQ-Ai provides the best way to Split PDF without losing quality, working perfectly on mobile devices. Our secure Split PDF tool ensures your documents stay private by processing everything locally. Experience a fast Split PDF tool that handles complex page ranges effortlessly."
        faqs={[
