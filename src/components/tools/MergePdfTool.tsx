...
export const MergePdfTool: React.FC = () => {
  ...
  const mergePDFs = async () => {
    ...
    try {
      ...
      const fileName = `WorQ-Ai_MergePDF_${Date.now()}.pdf`;
    ...
    <div className="flex flex-col gap-4 w-full animate-in fade-in duration-300">
      ...
      <div className="mt-4 bg-brand-pink/5 p-5 rounded-2xl border border-brand-pink/20">
        ...
        <p className="text-gray-600 dark:text-gray-300 text-[14px]">
          ...
          <a 
            href="/blog/merge-pdf-online-free" 
            onClick={(e) => { 
              e.preventDefault(); 
          ...
          >
            Merge PDF Online Free (No Signup, Fast & Secure)
          </a>
        </p>
      </div>
    </div>
