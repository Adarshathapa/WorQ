...
export const FileManagerView: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full max-w-[1000px] mx-auto p-4 md:p-8 gap-6 animate-in fade-in slide-in-from-bottom-2 duration-400 bg-bg-base dark:bg-slate-950">
